...
function renderFooter(s) {
  ...
  return `<footer class="kdt-footer"><div class="kdt-container"><div class="kdt-footer-grid">
    ...
    <div><h2 class="kdt-footer-heading">Explore</h2><ul class="kdt-footer-list"><li><a href="${BASE}portfolio.html">Portfolio</a></li><li><a href="${BASE}media.html">Media</a></li><li><a href="${BASE}about.html">Company Profile</a></li><li><a href="${BASE}#contact">Contact us</a></li></ul></div>
