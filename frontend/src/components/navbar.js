...
<nav class="kdt-navbar" aria-label="Primary navigation">
  <div class="kdt-container">
    ...
    <div class="kdt-navbar-row"><div class="kdt-desktop-nav">
      ...
      ${navLink('portfolio.html', 'Portfolio')}${navLink('media.html', 'Media')}
