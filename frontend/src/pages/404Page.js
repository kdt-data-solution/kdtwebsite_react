  ...
  <main class="bg-[#0b0b0b] text-white">
    <div class="kdt-container px-0 grid grid-cols-1 lg:grid-cols-2 min-h-[620px]">
      <div class="kdt-hero-copy flex flex-col justify-center items-start">
        <p class="kdt-eyebrow text-gray-400 mb-4">Error 404</p>
        <h1 class="kdt-display text-white">Page not found</h1>
      ...
      <div class="bg-[#ededeb] flex items-center justify-center p-10">
        <img src="https://res.cloudinary.com/dpf1qvyzt/image/upload/v1776393286/404_ct4tbo.png" alt="Page not found" class="w-56 sm:w-72 h-auto" />
      </div>
    </div>
  </main>
`;
