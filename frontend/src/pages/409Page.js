  ...
  <main class="flex-1 flex items-center justify-center px-4 py-20 mt-20">
    <div class="flex flex-col md:flex-row items-center gap-8 md:gap-16 max-w-3xl">
      <div class="flex-shrink-0">
        <img src="https://res.cloudinary.com/dpf1qvyzt/image/upload/v1776393286/404_ct4tbo.png" alt="Conflict" class="w-48 sm:w-56 md:w-64 h-auto" onerror="this.style.display='none'" />
      </div>
      <div class="text-center md:text-left">
        <h1 class="text-7xl sm:text-8xl md:text-9xl font-black text-gray-900 leading-none">409</h1>
        <p class="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mt-2">Ooops! Conflict Detected</p>
